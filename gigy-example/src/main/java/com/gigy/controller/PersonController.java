...
public class PersonController {
	...
	public ResponseEntity<?> addPerson(@RequestBody Person person) {
		return new ResponseEntity<Person>(personRepo.save(person), HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Collection<Party>> getPersonParties(@PathVariable long id) {
		...
		if (person != null) {
			return new ResponseEntity<Collection<Party>>(person.getParties(), HttpStatus.OK);
		} else {
			return new ResponseEntity<Collection<Party>>(person.getParties(), HttpStatus.NOT_FOUND);
		}
	}
